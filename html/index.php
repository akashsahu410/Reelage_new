<?php include_once('header.php'); ?>
				...
				<div class="col-md-10">
					<div class="prze-lft-dis">
						...
						<div class="prze-membr">
							<h4><span class="mbr-count">50+</span>members have registered as a part of our <b>bentbiz family</b><span class="music"><img src="images/music.png"> </span> </h4>
						</div>
					</div>
				</div>
				<div class="col-md-2">
	...
	<section class="join-us wrapper pd-50">
		...
		<span class="ylow-ball"><img src="images/balls.png"></span>
	</section>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="snd-msg-hd">
							...
							<span class="pn-icn"><img src="images/pen.png"></span>
						</div>
					</div>
					<div class="col-md-7">
