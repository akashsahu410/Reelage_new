              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="prvacy-dicr">
                    ...
                    <p>
                      <b>Established in 1940,</b> Dancerio Dance Studio has
                      become a center for dance students with professional
                      aspirations
                    </p>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="prvcy-sec">
              ...
              <p>
                ...
                the use of Reelage.com (Acrid Technologies LLP)'s Website,
                located at{" "}
                <a href="https://www.reelage.com/">www.reelage.com.</a>
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Reelage if you do not agree
              ...
              <p>
                We employ the use of cookies. By accessing Reelage, you agreed
                to use cookies in agreement with the Reelage.com (Acrid
                Technologies LLP)'s Privacy Policy.{" "}
              </p>
              ...
              <p>
                Unless otherwise stated, Reelage.com (Acrid Technologies LLP)
                and/or its licensors own the intellectual property rights for
                all material on Reelage. All intellectual property rights are
                reserved. You may access this from Reelage for your own personal
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Republish
                  material from Reelage
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Sell, rent or
                  sub-license material from Reelage
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Reproduce,
                  duplicate or copy material from Reelage
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Redistribute
                  content from Reelage
                </li>
              </ul>
              ...
              <p>
                Reelage.com (Acrid Technologies LLP) reserves the right to
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>You are
                  entitled to post the Comments on our website and have all
                  necessary licenses and consents to do so;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>The Comments do
                ...
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>The Comments
                  will not be used to solicit or promote business or custom or
                  present commercial activities or unlawful activity.
                </li>
              </ul>

              <p>
                You hereby grant Reelage.com (Acrid Technologies LLP) a
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Government
                  agencies;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>Search engines;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>News
                  organizations;
                </li>
                <li>
                ...
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>System wide
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>commonly-known
                  consumer and/or business information sources;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>dot.com
                  community sites;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>associations or
                  other groups representing charities;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>online
                ...
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>internet
                  portals;
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>accounting, law
                  and consulting firms; and
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>educational
              ...
              <p>
                ...
                of Reelage.com (Acrid Technologies LLP); and (d) the link is in
              ...
              <p>
                ...
                by sending an e-mail to Reelage.com (Acrid Technologies LLP).
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>By use of our
                  corporate name; or
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>By use of the
                  uniform resource locator being linked to; or
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>By use of any
                  other description of our Website being linked to that makes
              ...
              <p>
                No use of Reelage.com (Acrid Technologies LLP)'s logo or other
              ...
              <ul>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>limit or
                ...
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>limit any of
                  our or your liabilities in any way that is not permitted under
                  applicable law; or
                </li>
                <li>
                  <i class="fa fa-circle" aria-hidden="true"></i>exclude any of
                  our or your liabilities that may not be excluded under
                  applicable law.
                </li>
              </ul>
